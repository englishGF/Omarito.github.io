	...
	<div class="col-sm-6">
		<div class="load_msg" id="scroll_messages">
			<?php 
				...
				while($row_msg = mysqli_fetch_array($run_msg)){
					...
					?>
					<div id="loaded_msg">
						<p><?php if($user_to == $user_to_msg AND $user_from == $user_from_msg){echo "<div class='message' id='blue' data-toggle='tooltip' title='$msg_date'>$msg_body</div><br><br><br>";}else if($user_from == $user_to_msg AND $user_to == $user_from_msg){echo "<div class='message' id='red' data-toggle='tooltip' title='$msg_date'>$msg_body</div><br><br><br>";} ?></p>
					</div>
					<?php
				}
		...
		<?php 
				...
				if($u_id == 'new'){
					...
					echo '
						<form action="" method="post">
							...
							<h4>Please refresh to recive or send a message!</h4>
							<div id="emoji">
								<h3><a style="text-decoration: none;" href="https://getemoji.com/">😃</a></h3>
							</div>
						</form><br><br>
					';
				}
			...
			if(isset($_POST['send_msg'])){
				...
				}else if(strlen($msg) > 45){
					echo "<h4 style='color: red;text-align: center;'>Message is too long! Use only 45 characters</h4>";
				}else{
					...
					<div class='row'>
						...
						<center>
							<div style='background-color: #e6e6e6;' class='col-sm-9'>
								...
								<img src='users/$user_image' width='150px' height='150px' class='img-circle'>
								<br><br>
								<ul class='list-group'>
