...
<div class="row">
	<div class="col-sm-12">
		<div class="well">
			<center><h1 style="color: white;"><strong>Omarito</strong></h1></center>
		</div>
	</div>
</div>
<div class="row">
			...
			<div class="l_pass">
				<form action="" method="post">
					...
					<div class="input-group">
						...
						<input id="msg" type="text" class="form-control" placeholder="Someone" name="recover_account" required>
					</div><br>
...
include("includes/connection.php");
    ...
    if (isset($_POST['submit'])) {
        ...
        $recover_account = htmlentities(mysqli_real_escape_string($con, $_POST['recover_account']));
