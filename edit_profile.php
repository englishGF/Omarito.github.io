							...
							<div class="modal-dialog">
								<div class="modal-content">
										...
										<?php 
											if(isset($_POST['sub'])){
												...
												if($bfn == ''){
													...
													echo "<script>window.open('edit_profile?u_id=$user_id','_self')</script>";
									...
									<div class="model-footer">
										<button style="float: right;" type="button" class="btn btn-default" data-dismiss="modal">❌</button>
									</div>
								</div>
							</div>
						</div>
